...
const HighlightItem = ({ icon: Icon, label, value }) => (
    <div
        style={{
...
const SectionHeader = ({ icon: Icon, title, color = '#64748b' }) => (
    <div
        style={{
            display: 'flex',
            alignItems: 'center',
                    ...
                    >
                        <style>{`
                            ...
                            @media (max-width: 860px) {
                                .pdm-grid { grid-template-columns: 220px 1fr; }
                                .pdm-header-title { max-width: 320px; font-size: 13px; }
                            }
                            @media (max-width: 640px) {
                                .pdm-grid { grid-template-columns: 1fr; overflow-y: auto; overflow-x: hidden; }
                                .pdm-left { border-right: none; border-bottom: 1px solid rgba(226,232,240,0.8); overflow-y: unset; min-height: unset; padding: 16px; gap: 12px; }
                                .pdm-right { overflow-y: unset; min-height: unset; padding: 16px; gap: 18px; }
                                .pdm-highlights-grid { grid-template-columns: repeat(2, 1fr); }
                                .pdm-reg-grid { grid-template-columns: 1fr; }
                                .pdm-header-title { max-width: 180px; font-size: 12px; }
                            }
                        `}</style>
