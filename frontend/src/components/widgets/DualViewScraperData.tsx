...
interface DualViewScraperDataProps {
    sourceALabel: string;
    sourceBLabel: string;
    sourceAData: Partial<Product>;
    sourceBData: Partial<Product>;
    loading?: boolean;
}

const fieldLabels: { key: keyof Product; label: string }[] = [
...
const DualViewScraperData: React.FC<DualViewScraperDataProps> = ({
